...
[**XML_Mascot_OrderResponse.xsd**](https://github.com/Mascot-International/integration-docs/blob/main/docs/XML/XML-Mascot/OrderResponse/XML_MASCOT_ORDER_RESPONSE_V1.xsd)
...
- [Standard Order Response](https://github.com/Mascot-International/integration-docs/blob/main/docs/XML/XML-Mascot/OrderResponse/Examples/OrderResponse_Standard.xml)  
- [With Discounts and Charges](https://github.com/Mascot-International/integration-docs/blob/main/docs/XML/XML-Mascot/OrderResponse/Examples/OrderResponse_DiscountsCharges.xml)  
- [With Multiple Deliveries](https://github.com/Mascot-International/integration-docs/blob/main/docs/XML/XML-Mascot/OrderResponse/Examples/OrderResponse_MultiDelivery.xml)
